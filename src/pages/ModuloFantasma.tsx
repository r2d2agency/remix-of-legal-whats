    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {data && (
            <Button variant="outline" onClick={() => exportGhostPDF(data, { logoUrl: orgInfo.logo_url, orgName: orgInfo.name, days: parseInt(days), appName: orgInfo.name })} className="gap-2">
